// Package e2e contains the guardian end-to-end test suite.
//
// These tests verify guardian's admission webhook lifecycle, RBACProfile enforcement,
// and IdentityProvider trust resolution on a live cluster.
//

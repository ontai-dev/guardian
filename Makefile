...
# docker-build builds the Guardian operator image (distroless, linux/amd64).
...
# lint-images verifies the Guardian image exists in the local OCI registry.
# Checks http://10.20.0.1:5000/v2/ontai-dev/guardian/manifests/$(TAG) for 200.
lint-images:

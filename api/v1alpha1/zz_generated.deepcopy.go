...
func (in *GuardianStatus) DeepCopyInto(out *GuardianStatus) {
	*out = *in
	if in.NamespaceEnforcements != nil {
		in, out := &in.NamespaceEnforcements, &out.NamespaceEnforcements
...
func (in *PermissionSnapshotSpec) DeepCopyInto(out *PermissionSnapshotSpec) {
	*out = *in
	...
	if in.SnapshotTimestamp != nil {
		in, out := &in.SnapshotTimestamp, &out.SnapshotTimestamp
		*out = (*in).DeepCopy()
	}
	if in.Subjects != nil {
